...
Machine-learning operations that are GPLed.
...
* the [developer guide](https://www.anchoranalysis.org/developer_guide.html), especially [anchor-plugins](https://www.anchoranalysis.org/developer_guide_repositories_anchor_plugins_gpl.html) for an overview of all modules in this repository.
